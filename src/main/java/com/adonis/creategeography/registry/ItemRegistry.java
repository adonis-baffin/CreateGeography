...
import com.adonis.creategeography.content.item.*;
...
import static com.adonis.creategeography.CreateGeography.REGISTRATE;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> ORTHOCLASE = registerWithTab("orthoclase", () -> new Item(basicItem()));
