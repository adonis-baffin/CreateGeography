...
//        CreateGeography.LOGGER.info("=== DataGenerators.gatherData called! ===");
//
...
//
//        CreateGeography.LOGGER.info("=== About to add Recipes provider ===");
//        generator.addProvider(event.includeServer(), new Recipes(output));
//        CreateGeography.LOGGER.info("=== Recipes provider added ===");
//    }
//}